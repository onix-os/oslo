...
//!   - Use [`Encryptor::with_recipients`] with [`x25519::Recipient`].
...
//!   a human.
//!
//! The `tag` and `tagpq` recipient types and the `ssh` feature are upstream's and are not in this
//! copy; see `vendor/README.md`.
//!
