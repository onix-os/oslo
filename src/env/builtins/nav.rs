...
use crate::ui::ask::Preset;
use crate::ui::ask::chrome::Chrome;
use crate::ui::nav::{Navigator, Outcome};
use crate::ui::{scanner::Scanner, settings, theme};
...
pub fn builtin_nav(env: &mut Environment, args: &[String]) -> Result<i32> {
    ...
    let chrome = Chrome {
        ...
        align_x: crate::ui::ask::chrome::Place::Center,
    ...
    let outcome = crate::ui::nav::open(&spec, |path| {
        let args = vec![
            "rm".to_string(),
            "--".to_string(),
