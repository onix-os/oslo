...
pub fn columns_for_rows(candidates: &[CompletionCandidate]) -> Vec<Vec<String>> {
    let descriptions = crate::interactive::settings::current()
        .completion
        .descriptions;
...
mod tests {
    ...
    fn turning_descriptions_off_drops_only_the_description() {
        ...
        crate::interactive::settings::install(crate::interactive::settings::Settings {
            completion: crate::interactive::settings::Completion {
                descriptions: false,
                ..Default::default()
            },
            ..Default::default()
        ...
        crate::interactive::settings::install(Default::default());
