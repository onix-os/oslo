...
//! in [`crate::ui::row`] that must all be the same printed width, the right prompt drawn
...
//!
//! The terminal half is already oslo's: raw mode and key decoding in [`crate::ui::term`],
//! and the scroll-safe redraw discipline in [`crate::ui::paint`].
