    ...
    loop {
        ...
        match pressed {
            ...
            Key::Delete => {
                ...
                } else if crate::ui::settings::current().finder.confirm_delete {
...
fn load_profile(name: &str) -> Vec<Command> {
    let limit = crate::ui::settings::current().finder.limit;
...
impl State {
    ...
    fn new(commands: &[Command], cwd: &str, fuzzy: Fuzzy, seed: &str) -> State {
        ...
        State {
            ...
            worktree: crate::ui::prompt::git_root_of(std::path::Path::new(cwd))
...
fn terminal_size() -> (usize, usize) {
    (
        crate::ui::dropdown::width::terminal_cols(),
        crate::ui::dropdown::width::terminal_rows(),
    )
}
