...
pub fn tokenize_str_with_options(
    ...
    static CACHE: std::sync::LazyLock<crate::memo::Memo<(String, TokenizerOptions), Vec<Token>>> =
        std::sync::LazyLock::new(crate::memo::Memo::new);
    CACHE.get_or_insert((input.to_owned(), options.to_owned()), || {
