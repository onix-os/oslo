//! Everything the scratch printed while nobody was watching, up to a cap.
//!
...
//! without attaching, and so that a scratch which has since exited still has something to read.
//!
