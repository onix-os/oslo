...
//!
//! **Asymmetric, on purpose.** Output from the tab is raw bytes: it is already a stream, nothing
...
//! full-screen program inside the tab draws for the wrong terminal.
//!
//! ```text
...
//! the shell inside the tab, which is a shell and already has a language.
