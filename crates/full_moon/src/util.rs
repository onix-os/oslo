...
/// Used by `serde(skip_serializing_if)` on an optional-vector field.
///
/// Restored behind the feature gate: it is dead without `serde`, and missing *with* it. Deleting
/// it outright made the crate build here and fail for anyone who turned the feature back on.
#[cfg(feature = "serde")]
#[allow(clippy::ptr_arg)]
